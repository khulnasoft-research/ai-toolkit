      ...
      it('should handle streaming web search with action query field', async () => {
        server.urls['https://api.openai.com/v1/responses'].response = {
          ...
          chunks: [
            ...
            `data:{"type":"response.output_item.added","output_index":0,"item":{"type":"web_search_call","id":"ws_test","status":"in_progress","action":{"type":"search","query":"KhulnaSoft AI TOOLKIT next version features"}}}\n\n`,
            ...
            `data:{"type":"response.output_item.done","output_index":0,"item":{"type":"web_search_call","id":"ws_test","status":"completed","action":{"type":"search","query":"KhulnaSoft AI TOOLKIT next version features"}}}\n\n`,
