...
The KhulnaSoft AI Gateway provider is part of the AI TOOLKIT.
...
2. **In Local Development**:
   - First, install and authenticate with the [Khulnasoft CLI](https://vercel.com/docs/cli)
...
Read more about using OIDC tokens in the [KhulnaSoft AI Gateway docs](https://vercel.com/docs/ai-gateway#using-the-ai-gateway-with-a-vercel-oidc-token).

## Bring Your Own Key (BYOK)

You can connect your own provider credentials to use with KhulnaSoft AI Gateway. This lets you use your existing provider accounts and access private resources.
...
const result = await generateText({
  ...
  prompt: 'What is the KhulnaSoft AI Gateway?',
