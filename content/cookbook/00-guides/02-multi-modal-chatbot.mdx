...
- A KhulnaSoft AI Gateway API key.
...
### Configure your KhulnaSoft AI Gateway API key

Create a `.env.local` file in your project root and add your KhulnaSoft AI Gateway API key. This key authenticates your application with KhulnaSoft AI Gateway.
...
Replace `your_api_key_here` with your actual KhulnaSoft AI Gateway API key.
