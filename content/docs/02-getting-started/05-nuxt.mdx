...
Install `ai` and `@ai-toolkit/vue`. The KhulnaSoft AI Gateway provider ships with the `ai` package.
...
### Configure KhulnaSoft AI Gateway API key

Create a `.env` file in your project root and add your KhulnaSoft AI Gateway API Key. This key is used to authenticate your application with the KhulnaSoft AI Gateway service.
...
Replace `xxxxxxxxx` with your actual KhulnaSoft AI Gateway API key and configure the environment variable in `nuxt.config.ts`:
