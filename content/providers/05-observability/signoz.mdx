...
## Enable Telemetry for KhulnaSoft AI TOOLKIT

The KhulnaSoft AI TOOLKIT uses [OpenTelemetry](https://signoz.io/blog/what-is-opentelemetry/) to collect telemetry data. OpenTelemetry is an open-source observability framework designed to provide standardized instrumentation for collecting telemetry data.

## Enabling Telemetry

Check out more detailed information about KhulnaSoft AI TOOLKIT’s telemetry options visit [here](https://studio.khulnasoft.com/docs/ai-toolkit-core/telemetry#telemetry).
...
Your KhulnaSoft AI TOOLKIT commands should now automatically emit traces, spans, and events. You can find more details on the types of spans and events generated [here](https://studio.khulnasoft.com/docs/ai-toolkit-core/telemetry#collected-data).
