...
The wrapped model works seamlessly with all KhulnaSoft AI TOOLKIT functions:
...
- After setting up Maxim tracing for the KhulnaSoft AI TOOLKIT, you can explore other Maxim platform capabilities:
...
For further details, checkout KhulnaSoft AI TOOLKIT's [Maxim integration documentation](https://www.getmaxim.ai/docs/sdk/typescript/integrations/vercel/vercel).
